...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    //查看是否登录成功，如果成功有session
    User login_user=(User)request.getSession().getAttribute("login_user");
    //String username=login_user.getUname();
    //String password=login_user.getUpass();
    %>
<!DOCTYPE HTML>
<html>
<head>
...
$(function(){
	if("<%if(login_user!=null)out.print(login_user.getUname());%>"!=null)
	{
		//如果登录成功
		//$("#loginBox").hide(1000);
		$("#loginForm").append("<span>Username:<%if(login_user!=null)out.print(login_user.getUname());%></span>");
	}
});
</script>
</head>
